<x-layout>
    ...
    <section id="coffrets" class="overflow-hidden px-3 py-16 sm:px-5 sm:py-20 lg:px-8 lg:py-28">
        <div class="mx-auto max-w-[1560px]">
            ...
            <div class="-mx-3 mt-12 flex snap-x snap-mandatory gap-2 overflow-x-auto px-5 pb-4 sm:-mx-5 sm:gap-5 sm:px-5 lg:mx-0 lg:grid lg:grid-cols-3 lg:gap-8 lg:overflow-visible lg:px-0 lg:pb-0" data-blur-reveal data-blur-stagger="0.12" data-blur-duration="0.85" data-blur-y="22" data-blur-pixels="10">
                @foreach ($coffrets as $product)
                    ...
                    <article class="group w-4/5 shrink-0 snap-start sm:w-1/2 lg:w-auto @if ($loop->iteration === 2) lg:pt-12 @endif" data-blur-reveal-item>
                ...
                <div class="flex items-center p-16 sm:p-10 lg:p-14 xl:p-24">
                    <div class="max-w-xl">
                        ...
                        <h2 class="mt-5 font-serif text-4xl font-medium leading-none tracking-tight text-zinc-900 sm:text-5xl lg:text-6xl" data-reveal-title data-reveal-title-duration="1" data-reveal-title-stagger="0.08">
                            <span class="inline-block">{{ __('Née') }}</span>
                            <span class="inline-block italic text-white">{{ __('de la') }}</span>
                            <span class="inline-block">{{ __('pratique') }}</span>
                        </h2>

                        <div class="mt-7 space-y-5 text-base leading-7 text-zinc-700 sm:text-lg" data-blur-reveal data-blur-stagger="0.1" data-blur-duration="0.8" data-blur-y="14" data-blur-pixels="7">
                            <p data-blur-reveal-item>
